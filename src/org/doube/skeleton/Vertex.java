...
public class Vertex {
	 ...
	 */
	public boolean isVertexPoint(final Point p) {
		if (points == null)
			return false;
	 ...
	 *            neighbor edge
	 */
	public void setBranch(final Edge e) {
		this.branches.add(e);
	}
	 ...
	 *            boolean flag
	 */
	public void setVisited(final boolean b, final int visitOrder) {
		this.visited = b;
	 ...
	 */
	public void setPredecessor(final Edge pred) {
